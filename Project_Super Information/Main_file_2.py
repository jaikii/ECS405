...
for file in files:
	...
	scatter(range(len(P_value_coding)),P_value_coding,color='red')
	scatter(range(len(P_value_non_coding)),P_value_non_coding,color='blue')
	show()
	...
	plot(range(len(super_entropy_coding)),super_entropy_coding)
	plot(range(len(super_entropy_non_coding)),super_entropy_non_coding)
	show()
